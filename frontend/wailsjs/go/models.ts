export namespace app {
	...
	export class UISettings {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.altUsers = this.convertValues(source["altUsers"], AltUser);
	    }
	...
	export class XferListing {
	    dir: string;
	    entries: xfer.Entry[];
	
	    static createFrom(source: any = {}) {
	        return new XferListing(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.dir = source["dir"];
	        this.entries = this.convertValues(source["entries"], xfer.Entry);
	    }
